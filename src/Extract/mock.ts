const mockETHResponse = {
  ...
  nonce: "0",
  blockHash:
    "0x07d52b7228f5d5ca28ffdc83b40b4452bdebe19ade28f100fd209d6029c88b08",
  transactionIndex: "47",
...
const mockBTCResponse = {
  ...
  vin: [
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm:
          "OP_DUP OP_HASH160 OP_PUSHBYTES_20 7a26297168712de2a131db56f99346db9b4d8315 OP_EQUALVERIFY OP_CHECKSIG",
        scriptpubkey_type: "p2pkh",
        scriptpubkey_address: "1C8s9wPNaXwYAAP5gfgP7nkQwTzJfxEQAy",
        value: 4350,
      },
      scriptsig:
        "4830450221009a88dfd0f94f49d29226c3516f0bf34ac5da4373bd0a51734965057d51373dc802204313c770f21e0bf3310152275382366dfcea75bcbb1fdaa4fe3cf8b7bc9012ef012103e567d0aff2716b1c4c678e7017088217727d4bde6e7eeaa04da3da423a4b41f8",
      scriptsig_asm:
        "OP_PUSHBYTES_72 30450221009a88dfd0f94f49d29226c3516f0bf34ac5da4373bd0a51734965057d51373dc802204313c770f21e0bf3310152275382366dfcea75bcbb1fdaa4fe3cf8b7bc9012ef01 OP_PUSHBYTES_33 03e567d0aff2716b1c4c678e7017088217727d4bde6e7eeaa04da3da423a4b41f8",
      is_coinbase: false,
      sequence: 4294967295,
    },
  ],
  vout: [
    {
      ...
      scriptpubkey_asm:
        "OP_DUP OP_HASH160 OP_PUSHBYTES_20 091890b943c553bed9389a7efd6fc45e0a960a78 OP_EQUALVERIFY OP_CHECKSIG",
      scriptpubkey_type: "p2pkh",
    ...
    },
    {
      ...
      scriptpubkey_asm:
        "OP_DUP OP_HASH160 OP_PUSHBYTES_20 9f34435954d59c46024dc8ad27ea70e10b8d29bc OP_EQUALVERIFY OP_CHECKSIG",
      scriptpubkey_type: "p2pkh",
  ...
  status: {
    ...
    block_height: 791408,
    block_hash:
      "0000000000000000000329ab83e7f51cf0a6a932701e0b83f50e03f84c546159",
...
export const ETHBalanceDataMock = [
  {
