...
const ComunicationSystemAuth_1 = __importDefault(
  require("../services/ComunicationSystemAuth")
);
...
const sendTransferEmail_1 = require("../Domain/sendTransferEmail");
...
let AuthResolver = class AuthResolver {
  ...
  async SendTransferCodeEmail(Email) {
    return await (0, sendTransferEmail_1.SendTransferEmail)(Email);
  }
};
__decorate(
  [
...
AuthResolver = __decorate([(0, type_graphql_1.Resolver)()], AuthResolver);
