...
exports.SendTransferEmail = void 0;
...
async function SendTransferEmail(destinatario) {
    ...
    const templatePath = path.resolve(__dirname, "..", "..", "EmailTemplates", "Transfer.html");
    ...
    const message = {
        ...
        to: destinatario,
        subject: "Código de Transferência Credit Black",
        attachment: [
            {
...
exports.SendTransferEmail = SendTransferEmail;
